 ...
 *
 * WARNING: this script has rounding issues
 * the final extrabalance.json will be generated by this script https://github.com/lyricalpolymath/Ethereum_DaoExtraBalanceOwners
 * that has got the same results as this other one https://github.com/bokkypoobah/TheDAOData/blob/master/getTheDAOCreatedTokenEventsWithNonZeroExtraBalance_v3
 *
	...
	if(error) {
		...
		for(var i = 0; i < blockNumbers.length; i++) {
			...
			for(var address in blockMap) {
				...
				// value = (tokens * extraBalanceDelta) / tokenDelta
				// WARNING: this will yield rounding errors - the real output will be generated by https://github.com/lyricalpolymath/Ethereum_DaoExtraBalanceOwners
